...
# Тема проекта: Реакторный техник

ФИО: _Федоров Алексей Алексеевич_\
Группа: _М8О-409Б-22_

## Видео
[Видео-демонстрация в файле demo.mp4](demo.mp4)
...
Используемые решения и подходы, особенности:
- Генерация уровня через алгоритм коллапса волновой функции с проверкой связности.
- Дополнительная физическая проверка проходов через Physics.OverlapBox, чтобы игрок реально мог пройти, а не только логически.
- BFS-проверка достижимости ключевых зон из точки старта.
- Робот прикольный
